    ...
    public static class DataGenerator
    {
        ...
        public static void GenerateMockData()
        {
            ...
            var refugeeFaker = new Faker<Refugee>()
                ...
                .RuleFor(r => r.DateOfBirth, f => f.Date.Past(50,DateTime.UtcNow).ToUniversalTime())
                .RuleFor(r => r.Gender, f => f.Person.Gender.ToString())
                .RuleFor(r => r.Nationality, f => f.Address.Country())
                .RuleFor(r => r.DateOfArrival, f => f.Date.Past(5, DateTime.UtcNow).ToUniversalTime())
                ...
                .RuleFor(r => r.FamilyId, f => f.Random.Int(1, 500));
